      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <span className="lg:hidden flex justify-center items-center">
            <img className="h-10 w-10" src={LOLO_Logo_1} alt="Logo" />
            <span
              className="dark:hidden m-auto ml-2 text-2xl text-black"
              style={{ fontFamily: "'astro'" }}
            >
              SRKR LOLO
            </span>
            <span
              className="hidden dark:block m-auto ml-2 text-2xl text-white"
              style={{ fontFamily: "'astro'" }}
            >
              SRKR LOLO
            </span>
          ...
          >
            {!isApplicationMenuOpen ? <ChevronDown /> : <ChevronUp />}
          </button>
