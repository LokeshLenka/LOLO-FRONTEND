  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              <span className="gradient-text">LoLo</span> Music
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-gray-300 max-w-3xl mx-auto">
              Makes You Say "YoYo" - Experience music like never before with our
        ...
        {/* Animated circles */}
        <div className="mt-64 absolute -bottom-40 left-1/2 transform -translate-x-1/2 w-[800px] h-[800px] border-2 border-lolo-pink rounded-full animate-pulse-slow border-2 shadow-[0px_0px_50px_5px,inset_0px_0px_50px_5px] shadow-lolo-pink"></div>
        <div
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3">Premium Sound Quality</h3>
            ...
            >
              ...
              <p className="text-gray-400">
                Access exclusive tracks, remixes, and behind-the-scenes content
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            >
              ...
              <p className="text-gray-300 mb-6">
                ...
                community, and a way of life. That's why we've built a platform
                that not only delivers exceptional audio quality but also
                connects artists with fans in meaningful ways.
              </p>
      ...
      <section className="py-20 bg-black relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <Link to="/register" className="btn btn-primary text-lg px-10 py-3">
              Get Started Today
            </Link>
          </motion.div>
        </div>
