...
interface UtrPublicUserStepProps {
    form: UseFormReturn<any>;
    prefix?: string;
}

export const UtrPublicUserStep: React.FC<UtrPublicUserStepProps> = ({
    form,
    prefix = "",
}) => {
    const branches = [
    ...
    return (
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <FormField
                    control={form.control}
                    name={getName("college_hostel_status")}
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel className={labelStyle}>Residing in college hostel ? *</FormLabel>
                            <FormControl>
