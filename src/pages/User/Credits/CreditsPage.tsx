...
export default function CreditsPage() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full mx-auto flex flex-col md:flex-row gap-4 items-center justify-between sticky top-16 md:top-20 z-30 py-4 bg-white/80 dark:bg-black/80 backdrop-blur-2xl -mx-4 px-4 rounded-b-2xl border-b border-black/5 dark:border-white/5 transition-all">
